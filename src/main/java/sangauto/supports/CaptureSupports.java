...
public class CaptureSupports extends ScreenRecorder {
    ...
    //Hàm xây dựng
    public CaptureSupports(GraphicsConfiguration cfg, Rectangle captureArea, Format fileFormat, Format screenFormat, Format mouseFormat, Format audioFormat, File movieFolder, String name) throws IOException, AWTException {

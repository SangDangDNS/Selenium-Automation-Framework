...
public class WebUI {
    ...
    public static void openURL(String url) {
        ...
        waitForPageLoaded();
        if (PropertiesSupports.getValue("SCREENSHOT_STEP").equals("yes")) {
            CaptureSupports.takeScreenshot("openURL_" + Supports.makeSlug(url));
        }
    }
    ...
    public static void clickElement(By by) {
        ...
        if (PropertiesSupports.getValue("SCREENSHOT_STEP").equals("yes")) {
            CaptureSupports.takeScreenshot("clickElement_" + Supports.makeSlug(by.toString()));
        }
    }
    ...
    public static void setText(By by, String value) {
        ...
        if (PropertiesSupports.getValue("SCREENSHOT_STEP").equals("yes")) {
            CaptureSupports.takeScreenshot("setText_" + Supports.makeSlug(by.toString()));
        }
    }
    ...
    public static void scrollToElement(WebElement element) {
        ...
        if (PropertiesSupports.getValue("SCREENSHOT_STEP").equals("yes")) {
            CaptureSupports.takeScreenshot("scrollToElement_" + Supports.makeSlug(element.getText()));
        }
    }
